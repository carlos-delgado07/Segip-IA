...
def verificar_usuario_en_imagenes():
    ...
    try:
        ...
        for usuario in usuarios.get("usuarios", []):
            ...
            if (nombres in texto1 and apellidos in texto1 and nombres in texto2 and apellidos in texto2):
        ...
        if usuario_encontrado:
            ...
            return jsonify({'mensaje': 'Los nombres y apellidos no coinciden en ambas imágenes o no están en la base de datos'}), 404
